...
<form method="POST" action="<?php echo base_url().'admin/customer/search'; ?>">   
  <input type="text" value="<?php if(!empty($name)) echo $name; ?>" style="margin:5px; width:300px" placeholder="Find Customer by name" name="fullname" id="fullname" />
  <input type="text" value="<?php if(!empty($phone)) echo $phone; ?>" style="margin:5px;width:300px" placeholder="Find Customer by phone" name="phone" id="phone" />
