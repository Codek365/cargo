...
<?php if(!empty($listOrder)){ ?>
    <?php foreach ($listOrder as $order) { ?>
        <!--TABLE CONTAINER-->
        <div class="row-fluid">
                <a target="_blank" href="<?php echo base_url() . 'admin/order/addonly?sender=#&consignee=#' ?>" class="btn"><i class="icon20  i-stack-plus"></i> Create New Order For This Consignee</a>
                <a  href="<?php echo base_url() . 'admin/customer/editreceiver?sender=#&receiver='; ?>" class="btn"><i class="icon20 i-pencil-2"></i> Edit This Consignee</a>                                
                <a target="_blank" href="<?php echo base_url().'admin/order/edit?order_id='; ?>" class="btn" id="edit_order"><i class="icon20  i-pencil-3"></i>Edit This Order</a>
        </div>       
    <div class="row-fluid">
        <div class="span12">                  
