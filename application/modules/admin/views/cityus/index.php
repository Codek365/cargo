...
<div class="span12">
            <div class="widget">
              <div class="widget-title">
                ...
                <h4><a href="<?php echo base_url().'admin/cityus/addus/'.$state_code;?>">ADD NEW</a></h4>
                <a href="#" class="minimize"></a> </div>
              <!-- End .widget-title -->

                <div class="widget-content">
                 <div class="page-header"> <h4><a href="<?php echo base_url().'admin/state/statesus';?>">State</a></h4> </div>
         <div id="dataTable_wrapper" class="dataTables_wrapper form-inline" role="grid">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover dataTable" id="dataTable" aria-describedby="dataTable_info">
               ...
               <tbody id="tbl_menu" role="alert" aria-live="polite" aria-relevant="all">
                  ...
                  <tr>
                      <td style="text-align:center"><a style="color:gray;text-decoration:none" href="<?php //echo base_url().'admin/cityus/index/'.$item["id"]; ?>"><?php echo $item["city"]; ?></a></td>
                      <td style="text-align:center"><a style="color:gray;text-decoration:none" href="<?php //echo base_url().'admin/cityus/index/'.$item["id"]; ?>"><?php echo $item["state_code"]; ?></a></td>
                      <!-- <td style="text-align:center"><?php //if($country=='vn') echo "VN"; else echo "USA";?></td> -->
                      <td style="text-align:center">
                        <div class="btn-group">
                            <a class="btn" href="<?php echo base_url().'admin/cityus/loadoneus/'.$item['id'];?>"><i class="icon20 i-pencil-5"></i></a>&nbsp;&nbsp;
                            <a class="btn" accesskey="AL" href="<?php echo base_url().'admin/cityus/delus/'.$item['id'];?>" onclick="return xacnhan('Are you sure?');"><i class="icon20 i-remove-2"></i></a>
                        </div>
                      </td>
                  </tr>
