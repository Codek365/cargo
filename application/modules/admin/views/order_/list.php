         ...
         <table class="table table-bordered checkAll">
            ...
            <?php foreach ($info as $value) {?>
               <tr id="<?php echo $value['order_id'] ?>">
                  ...
                  <td><?php echo $trackingcode['tracking_code_prefix'].$value['order_id']; ?></td>
                  <td><?php
                        ...
                        ?></td>
                  <td><?php echo $value['order_sum_price']; ?></td>
                  <td><?php echo $value['order_ibs']; ?></td>
                  <td><?php echo $value['order_box']; ?></td>
                  <td><?php echo $value['type_ship_name']; ?></td>
                  <td><?php echo $value['type_payment_name']; ?></td>
                  <td><a href="#" class="gap-right10 tip" title="" data-original-title="<?php echo $value['order_message']; ?>"><i class="icon32 i-bubble"></i></a>
                  ...
                  <td><?php
                      ...
                      ?></td>
                  <td><a target="_blank" href="<?php echo base_url().'admin/form/printForm?id='.$value['order_id'].'&form=shiprequest'; ?>"><i class="icon20 i-print-2"></i></a></td>
                  <td><a target="_blank" href="<?php echo base_url().'admin/order/edit?order_id='.$value['order_id']; ?>"><i class="icon20  i-pencil-3"></i></a></td>
               </tr>
            <?php } ?>
            </tbody>           
         </table>         
