...
<div class="span12">
 ...
 <div>  </div>
      <div class="btn-group">
          <button class="btn dropdown-toggle" data-toggle="dropdown"><i class="icon20  i-settings"></i>Toolbar<span class="caret"></span></button>
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url().'admin/order/' ?>"><i class="icon20 i-clipboard-4"></i>Order List</a></li>
          <li><a href="<?php echo base_url().'admin/customer/' ?>"><i class="icon20  i-users-3"></i>Customer List</a></li>
