...
<div class="wrap">
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td width="45%"  class="border-b"><?php if(!empty($_GET['id'])) {echo $customer['customer_name'];} ?></td>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr>
			...
			<?php 
			if(!empty($_GET['id'])) {
				echo $customer['customer_address'].','.$customer['customer_address2'];
				} ?>
				</td>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td class="border-b"><?php if(!empty($_GET['id'])) {echo $customer['customer_passcode'];} ?></td>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td  class="border-b"><?php if(!empty($_GET['id'])) {echo $zone_customer['city'].',';} ?></td>

			<td width="10%">Tiểu bang:</td>

			<td  class="border-b"><?php if(!empty($_GET['id'])) {echo $zone_customer['state'].',';} ?></td>

			<td width="10%">Zip code:</td>

			<td  class="border-b"><?php if(!empty($_GET['id'])) {echo $customer['customer_zipcode'];} ?></td>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td  class="border-b">&nbsp;<?php if(!empty($_GET['id'])) {echo $customer['customer_remark'];} ?></td>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		...
		<tr class="border">
			...
			<td width="50%">
				...
				<h3>Membership number: <?php if(!empty($_GET['id'])) {echo $this->system->field('member_prefix').$customer['customer_id'];} ?></h3>

			</td>

			<td>

				<h3>AD Code:<?php echo  $this->session->userdata('username').'-'.$this->session->userdata('usergroup').'-'.$this->session->userdata('user_id')?></h3>
