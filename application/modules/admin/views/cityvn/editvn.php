            ...
            <div class="widget">
              ...
              <!-- End .widget-title -->
                ...
                <div class="widget-content">
                 ...
                 <?php } ?>
                 <!--  báo thành công -->
            <form id="validate" class="form-horizontal" action="<?php echo base_url().'admin/cityvn/editvn/'.$id;?>" method="post">
                 ...
                 <div class="controls controls-row">
                  ...
                  <div class="controls controls-row">
                    <!-- <label name="state_code" class="control-label" style="text-align:left;" for="normal"><?php 
                    // if(set_value('state')) 
