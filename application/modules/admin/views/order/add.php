...
<form id="f_order" action="<?php echo base_url().'admin/order/add'; ?>" method="POST">
...
<?php if($this->session->flashdata('success')){ ?>
          ...
          <div class="alert alert-success"> 
              ...
              <button type="button" class="close" data-dismiss="alert">×</button>
                  ...
                  <strong><i class="icon24 i-checkmark-circle"></i> Well done!</strong> Your order has been added successfully, Your tracking number is 

                    <span style="color:red; font-weight:bold"><?php echo $this->session->flashdata('success'); ?></span>
...
//PREVIEW SHIPPING REQUEST FORM
  ...
  $("#preview_order").on("click",function(){
    ...
    url=base_url+"admin/form/PreviewOrder?customer_name="+customer_name+"&customer_phone="+customer_phone;
    ...
    url+="&consignee_country="+consignee_country+"&consignee_state="+consignee_state+"&consignee_city="+consignee_city+"&order_sum_price="+order_sum_price;
