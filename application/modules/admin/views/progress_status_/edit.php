              ...
              <div class="widget-content">
                <form class="form-horizontal" action="<?php echo base_url().'admin/progress_status/update/'.$id; ?>" method="POST">
                  ...
                  <div class="control-group">
                    <label class="control-label" for="normal">Cargo progress name:</label>
                    <div class="controls controls-row">
                      <input type="text" style="width:250px;" name="order_status_name" value="<?php if(!empty($info['order_status_name']))echo $info['order_status_name']; ?>" id="normalField"><br />
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls controls-row">
                      <textarea class="span5" id="textarea" name="order_status_notes" rows="4"><?php if(!empty($info['order_status_notes']))echo $info['order_status_notes']; ?></textarea><br />
