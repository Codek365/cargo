        ...
        <?php $page=$this->router->fetch_class();?>
          <nav class="moduletable navigation  span6 left">
            <ul class="sf-menu   sticky" id="module-93">                              
              ...
              <li class="">
                <a href="<?php echo base_url().'video'; ?>">Video Clip</a>
              </li>
              <li ><a href="http://adongmall.com" target="_blank">Shopping</a></li>

              <!-- <li class="<?php echo $page=='blog'?'current active':""; ?>"><a href="<?php echo base_url().'blog'; ?>">Tin tức</a></li> -->
              <li class="<?php echo $page=='contact'?'current active':""; ?>"><a href="<?php echo base_url().'contact'; ?>">Liên lạc</a></li>
          ...
          <div class="mod-custom " style="padding: 12px 0px 15px 10px;">           
            <form style="margin:0 !important" method="post" action="<?php echo base_url();?>default/tracking/index" id="form"> 
                <div class="row ">         
                ...
                <div class="row">                  
                  <div class="span2 hid-icon" ><i class="fa fa-archive fa-2x fa-border" style="position:relative;z-index:1;color:#e17329;background:#fff;border:1px solid #fff;margin-top:0px;"></i></div>
                  <div class="span10" style="margin-left:-10px">
                  <input  id="track" type="text" placeholder="Enter tracking number" name="track" class="rd" style="width: 100% !important;height:34px;background:#fff;box-shadow:none; font-style: italic;"><i class="fa fa-search fa-2x cursor" style="color:#e17329;margin-left: -25px;margin-top:6px;background:#fff" onclick="document.getElementById('form').submit();"/></i></div>                 
