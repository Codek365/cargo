...
$config['dbuser'] = 'lab129_cargo';
$config['dbpass'] = 'dL597EEF7NlE';
$config['dbport'] = '3306';
$config['dbsocket'] = '';
$config['manual_db'] = 'adongcar_db';
$config['minspeed'] = '100';
...
$config['email_recipient'] = 'adongtechnology@gmail.com';
$config['email_recipient_cc'] = '';
$config['email_sender'] = 'adongtechnology@gmail.com';
$config['email_maxsize1'] = '10';
...
$config['ftp_server'][0] = '115.79.59.28';
$config['ftp_server'][1] = '';
$config['ftp_server'][2] = '';
...
$config['ftp_user'][0] = 'ken';
$config['ftp_user'][1] = '';
$config['ftp_user'][2] = '';
$config['ftp_pass']=array();
$config['ftp_pass'][0] = 'root';
$config['ftp_pass'][1] = '';
$config['ftp_pass'][2] = '';
$config['ftp_dir']=array();
$config['ftp_dir'][0] = '/download/sql_adc/';
$config['ftp_dir'][1] = '/';
$config['ftp_dir'][2] = '/';
$config['multi_part'] = '0';
...
$config['log_maxsize'] = '104857600';
$config['cron_dbindex'] = '-3';
$config['email_maxsize'] = '10485760';
...
$databases['db_actual'] = 'lab129_cargo';
