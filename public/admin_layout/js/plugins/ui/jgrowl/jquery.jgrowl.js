		...
		render:		 function( notification ) {
			...
			$(notification).bind("mouseover.jGrowl", function() {
				...
				if ( o.beforeOpen.apply( notification , [notification,message,o,self.element] ) != false ) {
					$(this).trigger('http://themes.suggelab.com/genyx/js/plugins/ui/jgrowl/jGrowl.open');
				}
			}).bind('http://themes.suggelab.com/genyx/js/plugins/ui/jgrowl/jGrowl.open', function() {
