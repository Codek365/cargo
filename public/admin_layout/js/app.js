...
$(document).ready(function() {
    ...
    $.genyxAdmin({
        ...
        collapseNavIcon: 'icon32 i-arrow-left-2 right', //icon for collapse navigation button
        collapseNavRestoreIcon: 'icon32 i-arrow-right-3', //icon for restore navigation button 
